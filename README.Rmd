...
The functions are used to make a report.
The first creates a "data bundle" which contains all the metric-level information needed by the report.
...
This example uses three _xlsx_ files which are included with the package in the "example_data" folder.
After you have run this example and created your first report, you should copy these example files to your machine, and use them as templates for creating your own report information.  
