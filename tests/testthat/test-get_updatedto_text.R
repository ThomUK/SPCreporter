...
test_that("updatedto_text handles dttms correctly 1", {
...
test_that("updatedto_text handles dttms correctly 2", {
  d1 <- lubridate::as_date("2024-02-01")
  d2 <- lubridate::as_datetime("2024-02-01")
...
test_that("get_updatedto_text: all aggregation types - Thursday date", {
...
test_that("get_updatedto_text: all aggregation types - Monday date", {
...
test_that("get_updatedto_text: error cases", {
