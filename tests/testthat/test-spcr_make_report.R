...
test_that("spcr_make_report: html and csv files are created", {
  skip_on_ci()
  skip_if(
...
test_that("spcr_make_report: html-only output creates no csv", {
  skip_on_ci()
  skip_if(
    system.file("Rmd", "Report.Rmd", package = "SPCreporter") == "",
    "Report.Rmd not found — run devtools::load_all() first"
...
test_that("spcr_make_report: returns invisible TRUE", {
  skip_on_ci()
  skip_if(
    system.file("Rmd", "Report.Rmd", package = "SPCreporter") == "",
    "Report.Rmd not found — run devtools::load_all() first"
