...
data_bundle <- spcr_make_data_bundle(data_wide, metric_config, report_config)
...
# build the accordion for each metric
walk(data_bundle$Ref, ~ spcr_render_accordion(data_bundle[., ]))
