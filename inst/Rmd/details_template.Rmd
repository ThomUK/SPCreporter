...
<div class="mini_card wide_card">
  <div class="mini_card_key">Updated to</div>
  <div class="mini_card_value {{stale_data}}">{{updated_to}}</div>
</div>

<div class="mini_card">
  <div class="mini_card_key">Target</div>
  <div class="mini_card_value">{{target_text}}</div>
</div>

<div class="mini_card">
  <div class="mini_card_key">Set by</div>
  <div class="mini_card_value">{{target_set_by}}</div>
</div>

<div class="mini_card">
  <div class="mini_card_key">Actual</div>
  <div class="mini_card_value">{{last_data_point}}</div>
</div>
