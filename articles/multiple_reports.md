...
This vignette covers a more advanced example, using {purrr} to map over
several versions of the configuration data files, to produce multiple
sets of reports.

You might do this to produce similar reports customised for different
business areas with a single command, or to produce tiered sets of
reports (low detail, medium detail, full detail) for use at different
levels in your business.

As a simple example the codes below generates 3 example reports with
